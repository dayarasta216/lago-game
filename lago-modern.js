(() => {
  ...
  function beginCharacterTap(
    ...
    /*
     * Only one physical pointer
     * may own the current tap.
     *
     * Prevents multi-touch farming.
     */
    if (
      activeTapPointer
    ) {
   ...
   * after the compatibility DOM exists.
   *
   * Build canonical UI immediately,
